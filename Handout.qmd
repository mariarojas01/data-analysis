...
The Linear Model is the main R function used to fit simple linear regression and multiple linear regression as well as ANOVA type models, polynomial regressions and interaction models. The basic sintax is the following:
