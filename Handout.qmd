...
In this project we examine the fundamental principles and applications of multiple linear regression, a widely used statistical method. At the same time it is intended to clarify how the method works and when it is appropriate to use.
